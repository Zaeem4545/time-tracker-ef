...
async function startTime(user_id, project_id, task_name, description, startTimeProvided = null) {
    const startTime = startTimeProvided ? new Date(startTimeProvided) : new Date();
